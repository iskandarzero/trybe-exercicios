...
const sendMarsTemperature = (delay, temperature) => {
  setTimeout(() => console.log(`Mars temperature is: ${temperature} deegre Celsius`), delay);
}
...
const sendMarsTemperature = (param, delay) => {
  const temperature = getMarsTemperature();
  setTimeout(() => param(temperature), delay);
}
...
const failRate = () => Math.floor(Math.random() * 101);
